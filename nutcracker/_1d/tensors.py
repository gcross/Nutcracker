...
class RightExpectationBoundary(Tensor): # {{{
    ...
    def contractWithLeftBoundary(self,left_boundary):
        return self.contractWithLeftBoundary_contractor(left_boundary,self)
# }}}
...
registerLegalGrouping(StateConjugateSite,"physical",(IterationStage1,"physical_conjugate"))
registerLegalGrouping(StateConjugateSite,"left",(IterationStage1,"state_conjugate"))
registerLegalGrouping(StateConjugateSite,"right",(RightExpectationBoundary,"state_conjugate"))
...
LeftExpectationBoundary.contractWithRightBoundary_contractor = staticmethod(makeTensorContractor( # {{{
    [LeftExpectationBoundary,RightExpectationBoundary],None,
    [Join(0,["state","state_conjugate","operator"],1,["state","state_conjugate","operator"])],
    None
))
RightExpectationBoundary.contractWithLeftBoundary_contractor = staticmethod(LeftExpectationBoundary.contractWithRightBoundary_contractor)
# }}}
...
IterationStage1.matvec_contractor = makeTensorContractor( # {{{
    ...
    [
        Join(0,["physical","state"],1,["physical","left"]),
        Join(0,"operator",2,"operator"),
        Join(1,"right",2,"state"),
    ],
    {
        "physical": [(0,"physical_conjugate")],
        "left": [(0,"state_conjugate")],
        "right": [(2,"state_conjugate")],
    }
) # }}}
