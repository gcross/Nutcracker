...
function norm_denorm_going_left( &
  ...
  site_tensor_to_normalize = reshape(normalized_tensor_workspace,shape(site_tensor_to_normalize),order=(/2,1,3/))
...
function norm_denorm_going_right( &
  ...
  site_tensor_to_denormalize = reshape( &
    denormalized_tensor_workspace_1, &
    shape(site_tensor_to_denormalize), &
    order=(/2,1,3/) &
  )
